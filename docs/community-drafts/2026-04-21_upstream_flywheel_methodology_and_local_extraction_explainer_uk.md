...
- `Assertion-Shape-Verify`  
  Якщо хтось каже "цей тест уже це ловить", читай саму форму перевірки, а не назву тесту.

- `No-Delta-No-Work`  
  Якщо зовнішній стан не змінився, не вигадуй нову роботу тільки для того, щоб виглядати зайнятим.

- `Trigger-Revalidate`  
  Якщо upstream merge, review feedback або scope change ламає стару картину, перевір передумови заново.
