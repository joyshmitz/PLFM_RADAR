# Shared Antenna Report Figures

This directory contains the curated figure set shared by both language variants of the `xpa-105-antenna-report`.
...
- `input-impedance.png`
- `vswr.png`
- `radiation-pattern-cartesian.png`
- `radiation-pattern-polar.png`
